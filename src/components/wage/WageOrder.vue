<template>
  <div>
    <wage-edit @onSubmit="getAllWageOrder()" ref="edit"></wage-edit>
    <el-table class="wageOrder" :data="tableData" border style="width: 100%">
      ...
      <el-table-column fixed="right" label="操作" width="100" align='center'>
        <template slot-scope="scope">
          ...
          <el-button @click.native.prevent="editWage(scope.row)" type="text" size="small">编辑</el-button>
        </template>
      </el-table-column>
    </el-table>
  </div>
...
<script>
import WageEdit from '../admin/content/WageEdit'
export default {
  name: 'WageOrder',
  components: {WageEdit},
  data () {
